...
input_dir = 'Input'
output_dir = 'Output'
model_dir = "Models/newsvision 3.0"
filename_suffix = "_extract_Tesseract.txt"
image_suffix = "_bboxes_Tesseract.jpg"
...
# Initialize the PPStructure model
...
for filename in os.listdir(input_dir):
    if filename.lower().endswith(('.jpg', '.png')):
        ...
        for res in layout_results:
            ...
            # OCR Call Block
            ocr_result = pytesseract.image_to_string(Image.fromarray(cropped_array), lang='chi_sim' if languages == 'ch' else 'eng')
